...
$JPEGquality = 75; // 0 = маленький файл и ужасное качество, 100 = отличное качество и огромный файл. Оптимум это 60-90
$PNGquality = 6; // 0 = no comression, 9 = max compression
$fontSZ = 4; // размер текста
$prozr = 30; // прозрачность 15-30 нормально
$threshold = 10; // плотность марок. чем больше значение, тем разряженнее, 8 нормально
